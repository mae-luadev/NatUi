...
function Library:Create(xHubName,xGameName, MinimizeGame)
	...
	local SidebarCorner1 = Instance.new("UICorner")
...
local minimize = false
	...
	Logo.MouseButton1Down:Connect(function()
		...
		Tween:Create(Logo, TweenInfo.new(.7, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut, 0, false), {ImageTransparency = 1}):Play()
		print(minimize)

		Slideurs.Enabled = true
		for gui, transparency in pairs(OldTransparency.UI) do
			Tween:Create(gui, TweenInfo.new(0.7, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut, 0, false), {BackgroundTransparency = transparency}):Play()
		end
		for gui, transparency in pairs(OldTransparency.Image) do
			Tween:Create(gui, TweenInfo.new(0.7, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut, 0, false), {ImageTransparency = transparency}):Play()
		end
	...
	FakeMain.Parent = Slideurs
	FakeMain.BackgroundColor3 = Color3.fromRGB(31, 30, 46)
	FakeMain.Position = UDim2.new(0.278277636, 0, 0.281287253, 0)
	...
	Topbar.BackgroundColor3 = Color3.fromRGB(40, 42, 60)
	Topbar.Size = UDim2.new(0, 580, 0, 40)
	Topbar.ZIndex = 2

	Close.Name = "Close"
	Close.Parent = Topbar
	Close.BackgroundColor3 = Color3.fromRGB(55, 74, 251)
	Close.BorderColor3 = Color3.fromRGB(0, 0, 0)
	Close.BorderSizePixel = 0
	Close.Position = UDim2.new(0.850000024, 0, 0.100000001, 0)
	...
	SidebarCorner1.CornerRadius = UDim.new(1, 0)
	SidebarCorner1.Name = "SidebarCorner"
	SidebarCorner1.Parent = Close

	SidebarCorner_2.Name = "SidebarCorner"
	SidebarCorner_2.Parent = Topbar

	Minimize.Name = "Minimize"
	Minimize.Parent = Topbar
	Minimize.BackgroundColor3 = Color3.fromRGB(55, 74, 251)
	Minimize.BorderColor3 = Color3.fromRGB(0, 0, 0)
	Minimize.BorderSizePixel = 0
	Minimize.Position = UDim2.new(0.730000019, 0, 0.100000001, 0)
	Minimize.Size = UDim2.new(0.100000001, 0, 0.800000012, 0)
	...
	Close.MouseButton1Down:Connect(function()
		...
		for i, gui in pairs(Slideurs:GetDescendants()) do
			if gui and gui:IsA("GuiObject") then
				...
				if gui ~= GameTitle and gui:IsA("Frame") or gui:IsA("TextButton") or gui:IsA("TextBox") or gui:IsA("TextLabel") or gui:IsA("ImageButton") or gui:IsA("ImageLabel") or gui:IsA("ScrollingFrame") then
